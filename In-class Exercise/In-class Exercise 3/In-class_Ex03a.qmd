...
```{r}
#| echo: false
mpsz_cl <- read_rds("K:/kalpitkulshrestha24/ISSS626/In-class Exercise/In-class Exercise 3/data/rds/mpsz_cl.rds")
```

```{r}
childcare_sf <- read_rds("K:/kalpitkulshrestha24/ISSS626/In-class Exercise/In-class Exercise 3/data/rds/childcare_sf.rds") 
