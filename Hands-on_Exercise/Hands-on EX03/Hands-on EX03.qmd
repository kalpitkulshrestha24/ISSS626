...
Now, we are importing and reading the forest fires data into R environment.
using *st_as_sf* we are converting foreign object into sf object
using *coords* we extracting or changing the spatial or spatial temporal point pattern.
then we transform the projection using *crs*.
...
tm_shape(shp = NULL, bbox = NULL, crs = NULL, is.main = NA, name = NULL, unit = NULL, filter = NULL, ...)
